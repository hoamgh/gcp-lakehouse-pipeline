...
This project is licensed under the [MIT License](LICENSE). Feel free to fork, adapt, and use it as a reference for your own Lakehouse implementations.
...
---
*Built to demonstrate modern Data Engineering best practices & Lakehouse architecture.*
